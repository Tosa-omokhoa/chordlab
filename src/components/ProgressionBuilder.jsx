...
export function ProgressionBuilder({ voice, loading, view, onViewChange }) {
    ...
    <div>
      ...
      <div style={{ marginBottom: '14px' }}>
        {view === 'Guitar' && displaySlot
          ? <Fretboard rootSemitone={displaySlot.root} intervals={CHORD_TYPES[displaySlot.type].intervals} />
